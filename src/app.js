...
ShelterInPlace.Application = (function () {
    var _init = function () {
        ...
        ShelterInPlace.Utilities.GetUserLocation(function (position) {
            var latLng = {
                lat: position.coords.latitude,
                lng: position.coords.longitude
            };

            var circle = new google.maps.Circle({center: latLng, radius: position.coords.accuracy});
        ...
        var _initAutocomplete = function (latLng, circle) {
            ...
            autocomplete.setOptions({
                strictBounds: true,
                // types: ['store'] @todo set allowed types https://developers.google.com/places/android-sdk/reference/com/google/android/libraries/places/api/model/Place.Type
            })
